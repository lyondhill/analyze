...
module.exports = class ExpressServ
  ...
  component_quick_stats_day: (req, res) ->
    db.query "SELECT count(*) as \"total\", count(distinct pd) as \"unique\", avg(rt) as \"response\" FROM webrequest WHERE ci='#{req.params.component}' and t>CURRENT_TIMESTAMP - INTERVAL '1' DAY", (err, result, moreResultSets) ->
      console.log(err) if err
      result[0]['response'] = "#{(eval(result[0]['response'])/1000).toFixed()} ms"
      res.send data: result, description: "Last 24 Hours"
  ...
  component_quick_stats_week: (req, res) ->
    redis.get "#{req.params.component}-quick_stats_week", (err, response) ->
      if response
        ...
        db.query "SELECT count(*) as \"total\", count(distinct pd) as \"unique\", avg(rt) as \"response\" FROM webrequest WHERE ci='#{req.params.component}' and t>CURRENT_TIMESTAMP - INTERVAL '7' DAY", (err, result, moreResultSets) ->
          console.log(err) if err
          result[0]['response'] = "#{(eval(result[0]['response'])/1000).toFixed()} ms"
          data = data: result, description: "Last 7 Days"
          res.send data
  ...
  component_quick_stats_month: (req, res) ->
    redis.get "#{req.params.component}-quick_stats_month", (err, response) ->
      if response
        ...
        db.query "SELECT count(*) as \"total\", count(distinct pd) as \"unique\", avg(rt) as \"response\" FROM webrequest WHERE ci='#{req.params.component}' and t>CURRENT_TIMESTAMP - INTERVAL '30' DAY", (err, result, moreResultSets) ->
          console.log(err) if err
          result[0]['response'] = "#{(eval(result[0]['response'])/1000).toFixed()} ms"
          data = data: result, description: "Last 30 Days"
          res.send data
  ...
  component_web_requests: (req, res) ->
    redis.get "#{req.params.component}-web_requests", (err, response) ->
      if response
        ...
        db.query "SELECT count(*) as \"total\", avg(rt) as \"average\", EXTRACT(hour from t) as \"hour\" FROM webrequest WHERE ci='#{req.params.component}' and t>CURRENT_TIMESTAMP - INTERVAL '1' DAY GROUP BY \"hour\" ORDER BY \"hour\"", (err, result, moreResultSets) ->
          console.log(err) if err
          data = data: result
          res.send data
  ...
  component_response_time: (req, res) ->
    redis.get "#{req.params.component}-response_time", (err, response) ->
      if response
        ...
        db.query "SELECT (quarter.count * 100.0) / (total.count * 1.0) as quarter, (half.count * 100.0) / (total.count * 1.0) as half, (one.count * 100.0) / (total.count * 1.0) as one, ((quarter.count + half.count + one.count) * 100.0) / (total.count * 1.0) as full_second, (two.count * 100.0) / (total.count * 1.0) as two, (three.count * 100.0) / (total.count * 1.0) as three, (four.count * 100.0) / (total.count * 1.0) as four, (more.count * 100.0) / (total.count * 1.0) as more FROM (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt <= 250000) quarter, (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt <= 500000  AND rt > 250000) half, (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt <= 1000000 AND rt > 500000) one, (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt <= 2000000 AND rt > 1000000) two, (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt <= 3000000 AND rt > 2000000) three, (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt <= 4000000 AND rt > 3000000) four, (SELECT COUNT(*) as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY AND rt >  4000000) more, (SELECT CASE COUNT(*) WHEN 0 THEN 1 ELSE COUNT(*) END as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY) total", (err, result, moreResultSets) ->
            console.log(err) if err
            data = data: result
            res.send data
  ...
  component_slowest_response: (req, res) ->
    redis.get "#{req.params.component}-slowest_response", (err, response) ->
      if response
        ...
        db.query "SELECT pt, avg(rt) as \"response\" FROM webrequest WHERE ci='#{req.params.component}' and t>CURRENT_TIMESTAMP - INTERVAL '1' DAY GROUP BY \"pt\" ORDER BY \"response\" DESC LIMIT 20", (err, result, moreResultSets) ->
          console.log(err) if err
          data = data: result
          res.send data
  ...
  component_most_viewed: (req, res) ->
    redis.get "#{req.params.component}-most_viewed", (err, response) ->
      if response
        ...
        db.query "SELECT pages.pt as pt, (pages.count * 100.0) / (total.count * 1.0) as \"percent\" FROM (SELECT pt, count(*) as \"count\" FROM webrequest WHERE ci='#{req.params.component}' and t>CURRENT_TIMESTAMP - INTERVAL '1' DAY GROUP BY pt) pages, (SELECT CASE COUNT(*) WHEN 0 THEN 1 ELSE COUNT(*) END as count FROM webrequest WHERE ci='#{req.params.component}' AND t>CURRENT_TIMESTAMP - INTERVAL '1' DAY) total ORDER BY \"percent\" DESC LIMIT 20;", (err, result, moreResultSets) ->
            console.log(err) if err
            data = data: result
            res.send data
