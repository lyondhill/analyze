(function() {
  ...
  module.exports = ExpressServ = (function() {
    ...
    ExpressServ.prototype.quick_stats_day = function(req, res) {
      return db.query("SELECT count(*) as \"total\", count(distinct pd) as \"unique\", avg(rt) as \"response\" FROM webrequest WHERE ai='" + req.params.app + "' and t>'2011-11-16'", function(err, rows, moreResultSets) {
        if (err) {
          return res.send(err);
        } else {
    ...
    ExpressServ.prototype.quick_stats_week = function(req, res) {
      return redis.get("" + req.params.app + "-quick_stats_day", function(err, response) {
        if (response) {
          ...
          return db.query("SELECT count(*) as \"total\", count(distinct pd) as \"unique\", avg(rt) as \"response\" FROM webrequest WHERE ai='" + req.params.app + "' and t>'2011-11-10'", function(err, result, moreResultSets) {
            console.log("query");
            res.send(result);
    ...
    ExpressServ.prototype.quick_stats_month = function(req, res) {
      return redis.get("" + req.params.app + "-quick_stats_week", function(err, response) {
        if (response) {
          ...
          return db.query("SELECT count(*) as \"total\", count(distinct pd) as \"unique\", avg(rt) as \"response\" FROM webrequest WHERE ai='" + req.params.app + "' and t>'2011-11-01'", function(err, result, moreResultSets) {
            console.log("query");
            res.send(result);
    ...
    ExpressServ.prototype.web_requests = function(req, res) {
      return redis.get("" + req.params.app + "-web_requests", function(err, response) {
        if (response) {
          ...
          return db.query("SELECT count(*) as \"total\", avg(rt) as \"response\", EXTRACT(hour from t) as \"hour\" FROM webrequest WHERE ai='4eb05aea48afd80192000057' and t>'2011-11-01' GROUP BY \"hour\" ORDER BY \"hour\"", function(err, result, moreResultSets) {
            res.send(result);
    ...
    ExpressServ.prototype.slowest_response = function(req, res) {
      return redis.get("" + req.params.app + "-slowest_response", function(err, response) {
        if (response) {
          ...
          return db.query("SELECT pt, avg(rt) as \"response\" FROM webrequest WHERE ai='4eb05aea48afd80192000057' and t>'2011-11-01' GROUP BY \"pt\" ORDER BY \"response\" DESC LIMIT 20", function(err, result, moreResultSets) {
            res.send(result);
    ...
    ExpressServ.prototype.most_viewed = function(req, res) {
      return redis.get("" + req.params.app + "-most_viewed", function(err, response) {
        if (response) {
          ...
          return db.query("SELECT pt, count(*) as \"count\" FROM webrequest WHERE ai='4eb05aea48afd80192000057' and t>'2011-11-01' GROUP BY \"pt\" ORDER BY \"count\" DESC LIMIT 20", function(err, result, moreResultSets) {
            res.send(result);
